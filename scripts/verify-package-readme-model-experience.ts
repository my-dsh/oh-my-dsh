...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-session-attention': { kind: 'none', reason: 'Browser-side presentation overlay over the session list; registers nothing model-facing.' },
  ...
  'packages/client/token-usage': { kind: 'none', reason: 'Browser-side dashboard over host-derived statistics; registers nothing model-facing.' },
  ...
  'packages/bundle/token-usage-dashboard': { kind: 'none', reason: 'The bundle inserts observer/listener rows and a browser panel; nothing here reaches a model request.' },
  'packages/bundle/session-attention': { kind: 'none', reason: 'The bundle inserts a browser-only overlay panel; nothing here reaches a model request.' },
  ...
  'packages/util/step-timing': { kind: 'none', reason: 'Pure step-timing fold primitive; registers nothing model-facing.' },
  'packages/util/zoned-time': { kind: 'none', reason: 'Pure zoned-time resolution primitive; registers nothing model-facing.' },
  ...
  'packages/session/token-usage': { kind: 'none', reason: 'The store observes the session stream and persists provider-reported accounting; it registers nothing model-facing.' },
