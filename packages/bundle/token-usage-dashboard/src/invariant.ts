/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-token-usage-dashboard`.
 * @module @deepseek-ai/dsh-token-usage-dashboard/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-token-usage-dashboard'

/** Cordis companion plugin name. */
export const name = 'token-usage-dashboard-bundle-invariant'
