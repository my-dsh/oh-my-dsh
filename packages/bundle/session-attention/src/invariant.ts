/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-session-attention`.
 * @module @deepseek-ai/dsh-session-attention/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-session-attention'

/** Cordis companion plugin name. */
export const name = 'session-attention-bundle-invariant'
